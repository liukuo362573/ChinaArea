    ...
    public class SqlHelper
    {
        ...
        public static string GetMySqlInsert(List<Area> list)
        {
            string create = @"CREATE TABLE IF NOT EXISTS `sys_area` (
                                  `id` bigint(10) NOT NULL COMMENT '编号（规则生成）',
                                  `parent_id` bigint(10) NOT NULL COMMENT '父地区ID',
                                  `area_name` varchar(100) NOT NULL COMMENT '地区名',
                                  `area_level` int(10) NOT NULL COMMENT '级别',
                                  PRIMARY KEY(`id`,`parent_id`)
                                ) ENGINE = InnoDB DEFAULT CHARSET = utf8 COMMENT = '地区表'; ";
            string insert = "INSERT INTO `sys_area` (`id`, `parent_id`, `area_name`,`area_level`) VALUES";
        ...
        public static string GetSqlServerInsert(List<Area> list)
        {
            ...
            string insert = "INSERT INTO sys_area (id, parent_id, area_name,area_level) VALUES ({0}, {1}, '{2}', {3})";
